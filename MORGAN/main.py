...
from dataset_utilities import plot_dendrogram, read_similarity_matrix, compute_semantic_similarity
import pandas as pd
...
def compute_similarities():
    ...
    #plt.title("ZapDev Dendrogram")
    # plot the top three levels of the dendrogram
    plot_dendrogram(clusters,truncate_mode="level", p=4)
    #plt.xlabel("Num of models ")
    #plt.show()
    plt.savefig("ecore_dendogram.pdf", format="pdf")
